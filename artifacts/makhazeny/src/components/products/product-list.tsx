...
import { AlertCircle, Edit2, Package, Search, Trash2, Truck } from 'lucide-react'
              ...
              <Table>
                <TableHeader>
                  <TableRow className="hover:bg-transparent">
                    ...
                    <TableHead className="font-semibold text-xs uppercase tracking-wide">{t('Supplier')}</TableHead>
                ...
                <TableBody>
                  {products.map((product) => (
                    <TableRow key={product.id} className="group">
                      ...
                      <TableCell>
                        {product.supplier ? (
                          <span className="inline-flex items-center gap-1.5 text-xs font-medium bg-primary/10 text-primary border border-primary/20 rounded-full px-2.5 py-0.5 whitespace-nowrap">
